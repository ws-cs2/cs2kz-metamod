...
namespace sigs
{
	...
	DECLARE_SIG(DebugLine, "\x48\x83\xEC\x58\x4C\x8B\xD9\x48\x8B\x0D\xB2\x4E\xC4\x00");
	DECLARE_SIG(DebugCross3D, "\x48\x8B\xC4\x48\x89\x58\x18\x55\x56\x57\x48\x8D\x68\xB9");
